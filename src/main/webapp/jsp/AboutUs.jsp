...
<body>
	...
	<div id="nav_bar">
		<div class="cart">
			<a href="./admincart.html" class="cart"><img src="car.png"
	...
	<div class="about">
		<div class="about-parent"
			style="position: relative; bottom: 30px; font-size: 25px;">
			<div class="ac">
				<h1>ABOUT US</h1>
			</div>
			<div class="para"></div>
	...
	<div class="ip">
		<div class="chil">
			<img
				src="https://cdn.pixabay.com/photo/2014/02/03/11/31/medications-257336_960_720.jpg"
	...
	<div class="chil2">
		...
		<div class="chil3">
			<img
				src="https://media.istockphoto.com/id/1220577245/photo/hand-to-hand-of-delivery-food-service-sending-delicious-from-restaurant-to-customer-without.jpg?b=1&s=170667a&w=0&k=20&c=5GdOziZwOvG3bf-_d20XCkuoEmRzh9geqQgVFObKLMo="
				alt="" width="550px" height="350px">
		</div>
	</div>
	<div class="chil5">
		<div class="trust">
			<img
				src="https://cdn.pixabay.com/photo/2018/04/07/13/11/medicine-3298451_1280.jpg"
				alt="" width="550px" height="350px">
		</div>
		<div class="trust1">
			<h1>TRUST</h1>
			<p>With the highest standards of ethical pharmacy practice,
				Netmeds is committed to providing authentic cum affordable medicines
	...
	<footer>
		<div class="ship">
			<div class="ship1">
				<img
					src="https://cdn.pixabay.com/photo/2022/01/31/22/46/icon-6985161__340.png"
					alt="" width="100px" height="100px">
			</div>
			<div class="foot">
				<h1 style="font-size: 40px; color: rgb(11, 185, 185);">Free
					Shiping</h1>
				<p style="font-size: 18px;">
					We provide free delivery to the <br> customers that allows
					customers to <br> have their orders shipped <br> to them
					at no cost
				</p>
			</div>
			<div class="foot1">
				<img
					src="https://media.istockphoto.com/id/954508832/vector/icon-swap-resumes-spinning-arrows-in-circle-vector-symbol-sync-renewable-product-exchange.jpg?s=612x612&w=0&k=20&c=oQmeijMO5jB85aVh2Vg4VNW1WfgXOotFGkCED1BMP9c="
					alt="" width="80px" height="80px">
			</div>
			<div class="foot2">
				<h1 style="color: rgb(11, 185, 185); font-size: 40px;">return</h1>
				<p style="font-size: 18px;">
					free return if the customer placed <br> the wrong product or
					if the <br> customer has any issue with <br> our product.
				</p>
			</div>
			<div class="cust">
				<img
					src="https://cdn.pixabay.com/photo/2022/01/11/21/17/icon-6931512__340.png"
					alt="" width="70px" height="70px">
			</div>
			<div class="cust1">
				<h1 style="color: rgb(11, 185, 185); font-size: 40px;">Customer
					Support</h1>
				<p style="font-size: 18px;">
					Customer support is an essential part <br> of any business
					that provides <br> products or services to customers. <br>
					It involves helping customers with <br> their questions,
					issues, feedback, <br> and complaints in a timely and <br>
					professional manner.
				</p>
			</div>
		</div>
