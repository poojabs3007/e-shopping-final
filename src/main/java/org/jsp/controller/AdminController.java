...
public class AdminController {
	...
	@PostMapping("/insert")
	public String insertProduct(@ModelAttribute Product product, @RequestParam MultipartFile image, ModelMap model)
			throws IOException {
		return adminService.insert(product, image, model);
	}
