...
<body>
	...
	<section id="nav_main">
		...
		<div id="nav_child2">
			...
			<div>
				<a href="./usersignup.html" target="_blank"
		...
		<div id="nav_child3">
			<a href="./cart.html" target="_blank" class="cart"><img
				src="car.png" alt="cart" width="30em" height="30em"
			...
			<div class="item2">
				...
				<div class="footer_image">
					<a
						...
						src="insta.png" alt="" height="30px" width="30px"
						...
						src="telegram.png" alt="" height="30px" width="30px"
